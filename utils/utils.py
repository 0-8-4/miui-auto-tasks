...
def check_config(config: dict) -> bool:
    if config.get('accounts'):
        for i in config.get('accounts'):
            if i.get('uid') == '' or i.get('uid') is None:
                return False
            if i.get('password') == '' or i.get('password') is None:
                return False
            if i.get('user-agent') == '' or i.get('user-agent') is None:
                return False
            if i.get('board-id') == '' or i.get('board-id') is None:
                return False
